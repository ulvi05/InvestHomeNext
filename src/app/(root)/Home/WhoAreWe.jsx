...
const InfoDiv = ({ icon, header, text }) => {
  return (
    <div className="px-[34px] py-[42px] w-[522px] h-[158px] rounded-[30px] shadow-[4px_10px_30px_0px_rgba(0,_0,_0,_0.06)] flex flex-row gap-[26px] bg-white mt-[60px] border-[3px] border-solid border-primary max-[1260px]:w-full max-[1260px]:h-auto max-[1260px]:mt-[30px] max-[1260px]:px-[20px] max-[1260px]:py-[30px]">
      <div className="h-full w-[100px] flex justify-center items-center">
        {icon}
      </div>
      <div className="flex flex-col justify-center items-start pr-[30px]">
        <h4 className="text-primary text-[19.4px] font-medium ">{header}</h4>
        <p className="text-3 text-[16px]/[26px] font-normal ">{text}</p>
      </div>
    </div>
  );
};
